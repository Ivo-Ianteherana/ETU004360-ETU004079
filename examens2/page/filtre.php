...
<div class="stats-bar">
    <div class="stat-item">
        <span class="stat-number"><?php echo $objettotals; ?></span>
        <span class="stat-label">Objets Total</span>
    </div>
    <div class="stat-item">
        <span class="stat-number"><?php echo $objetssdispo; ?></span>
        <span class="stat-label">Disponibles</span>
    </div>
    <div class="stat-item">
        <span class="stat-number"><?php echo $objetsemprunt; ?></span>
